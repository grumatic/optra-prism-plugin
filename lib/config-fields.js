 ...
 * field name. Fields may only be dropped once no released version reads them.
 */
...
/**
 * Field names no released version reads. Dropped from config on every read and
 * removed from disk by the next write.
 *
