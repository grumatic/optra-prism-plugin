...
function clampToWireLimitWithEvidence(text, maxDecodedBytes, maxEscapedBytes) {
  ...
  return {
    ...
    // This deliberately excludes lone-surrogate scrubbing. `truncated`
    // continues to record any payload mutation; consumers that need to
    // identify an actual server/wire size prefix clamp use this flag.
    sizeClamped,
  };
}
