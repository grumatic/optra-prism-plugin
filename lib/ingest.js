...
// Requires an ingest service that has deployed these fields: an older server rejects the whole request over an unrecognized field.
...
async function sendPrompt(payload, options = {}) {
  ...
  // Key order here must match frozenPayload in submit-handler.js.
