 ...
 * @param {{ tool_session_id: string, response_text: string, advisor_feedback?: string|null, elapsed_ms?: number }} payload
 * @returns {Promise<{ status: number, body: string }>}
 */
async function sendResponse(payload) {
  ...
  if (payload.advisor_feedback) body.advisor_feedback = payload.advisor_feedback;
