...
test('rateFor uses exact IDs, timestamp boundaries, open segments, and unpriced failures', () => {
  ...
  assert.deepEqual(before, { input: 1, output: 2, cacheRead: 0.1, cacheWrite: 0.2, cacheWrite1h: null, hasLongContextTier: false, longContext: null, revision: 19 });
  assert.deepEqual(atBoundary, { input: 3, output: 4, cacheRead: 0.3, cacheWrite: 0.4, cacheWrite1h: null, hasLongContextTier: false, longContext: null, revision: 19 });
