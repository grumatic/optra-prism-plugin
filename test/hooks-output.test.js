...
function writeSuccessfulIngestInterceptor(home) {
  ...
  fs.writeFileSync(interceptor, [
    ...
    // Host observations and prompt-evidence occurrences are idempotent,
    // ack-shaped routes (contract §5): echo the request's own identity field
    // back as an accepted ack, same as the real ingest service would.
